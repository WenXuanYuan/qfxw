  ...
  render() {
    return (
        <div className={`row ${styles}`}>
          ...
          <div className='col-offset-17 col-4'>
            <p className="admin"><a className="user" href="#"><i className="anticon anticon-user"></i>文科</a>&nbsp;,&nbsp;欢迎回来&nbsp;!<a className="out" href="#">[退出]</a></p>
          </div>
        </div>
    );
  }
